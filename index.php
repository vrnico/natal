...
Function Find_Specific_Report_Paragraph($phrase_to_look_for, $file)
{
  ...
  if (isset($_POST['submitted']))
  {
    ...
    else
    {
      ...
      echo "<center><font size='+1' color='#0000ff'><b>ↂ</b></font></center>";
      ...
      if ($unknown_time == 0)
      {
        ...
        //get header first
        echo "<center><font size='+1' color='#0000ff'><b>RISING SIGN/ASCENDANT</b></font></center>";
      ...
      //display closing
      echo "<br><center><font size='+1' color='#0000ff'><b></b></font></center>";
